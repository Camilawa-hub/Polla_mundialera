      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-center gap-4 mb-4">
          <div className="flex-1 text-right">
            <span className="font-semibold text-sm">{partido.equipoLocal}</span>
          </div>
          ...
          <div className="flex-1 text-left">
            <span className="font-semibold text-sm">{partido.equipoVisitante}</span>
          </div>
        </div>
        ...
        {finalizado && partido.golesLocal !== null && (
          <div className="text-center text-sm text-muted-foreground mb-3">
            ...
            <span className="font-bold text-foreground">
              {partido.equipoLocal} {partido.golesLocal} - {partido.golesVisitante}{" "}
